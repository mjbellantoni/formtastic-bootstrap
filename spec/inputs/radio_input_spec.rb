  ...
  describe 'for belongs_to association' do
    ...
    describe "each choice" do
      ...
      it 'should contain a label for the radio input with a nested input and label text' do
        ::Author.all.each do |author|
          ...
          output_buffer.should have_tag("form div.control-group div.controls ul li label[@for='post_author_id_#{author.id}']")
        end
      end

      it 'should use values as li.class when value_as_class is true' do
        ::Author.all.each do |author|
          output_buffer.should have_tag("form div.control-group ul li.author_#{author.id} label")
        end
      end

      it "should have a radio input" do
        ::Author.all.each do |author|
          output_buffer.should have_tag("form div.control-group div.controls ul li label input#post_author_id_#{author.id}")
          output_buffer.should have_tag("form div.control-group div.controls ul li label input[@type='radio']")
          output_buffer.should have_tag("form div.control-group div.controls ul li label input[@value='#{author.id}']")
          output_buffer.should have_tag("form div.control-group div.controls ul li label input[@name='post[author_id]']")
        end
      end
      ...
      it "should mark the input as disabled if options attached for disabling" do
        ...
        output_buffer.should_not have_tag("form div.control-group div.controls ul li label input[@value='test'][@disabled='disabled']")
        output_buffer.should have_tag("form div.control-group div.controls ul li label input[@value='try'][@disabled='disabled']")
      end
      ...
      it "should not contain invalid HTML attributes" do
        ...
        output_buffer.should_not have_tag("form div.control-group div.controls ul li input[@find_options]")
      end
    ...
    describe 'and no object is given' do
      ...
      it 'should generate an li tag for each item in the collection' do
        output_buffer.should have_tag('form div.control-group div ul li', :count => ::Author.all.size)
      end
