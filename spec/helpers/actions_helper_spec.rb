  ...
  describe 'without a block' do
    ...
    describe 'with no args (default buttons)' do
      ...
      it 'should render a list item in the ol for each default action' do
        output_buffer.should have_tag('form fieldset.form-actions input.action.input_action', :count => 1)
      end
    ...
    describe 'with button names as args' do
      ...
      it 'should render a form with a fieldset containing a list item for each button arg' do
        output_buffer.should have_tag('form > fieldset.form-actions > .action', :count => 3)
      end
